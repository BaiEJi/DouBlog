  ...
  <SidebarMenu>
    ...
    <template v-else>
      ...
      <div
        ...
        class="flex flex-col items-center justify-center py-vscode-8 px-vscode-4 text-vscode-text-muted"
      >
        <svg
          class="w-12 h-12 mb-vscode-2 opacity-50"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        <span class="text-vscode-sm">No articles yet</span>
      </div>
    </template>
  </SidebarMenu>
</template>
