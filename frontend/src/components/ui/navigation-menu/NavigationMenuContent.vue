...
<template>
  <NavigationMenuContent
    ...
    :class="cn(
      ...
      'group-data-[viewport=false]/navigation-menu:bg-vscode-bg-elevated group-data-[viewport=false]/navigation-menu:text-vscode-text-primary',
      ...
      'group-data-[viewport=false]/navigation-menu:border group-data-[viewport=false]/navigation-menu:border-vscode-border',
      'group-data-[viewport=false]/navigation-menu:shadow-lg group-data-[viewport=false]/navigation-menu:duration-200',
